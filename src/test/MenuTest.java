...
public class MenuTest {
    ...
    public void testAddSpecial() {
        ...
        assertTrue(menu.getSpecials().contains(meal));
    ...
    public void testRemoveSpecial() {
        ...
        assertFalse(menu.getSpecials().contains(meal));
        assertTrue(menu.getAvailMeals().contains(meal));
    }
    ...
    public void testUpdateSpecialPrice() {
        ...
        assertEquals(20.0, meal1.getDiscount());
        assertEquals(20.0, meal2.getDiscount());
    }
